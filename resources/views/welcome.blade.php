...
SmartPhone Compatible web template, free WebDesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!--webfonts-->
    <link href='{{asset('backend//fonts.googleapis.com/css?family=Roboto+Condensed:400,300,300italic,400italic,700,700italic')}}' rel='stylesheet' type='text/css'>
    <!--//webfonts-->
    <!--animate-->
...
{{--                    </li>--}}
{{--                    <li>--}}
{{--                        <a href="{{route('agencys.index')}}"><i class="fa fa-th-large nav_icon"></i>List City <span class="nav-badge-btm">08</span></a>--}}
{{--                    </li>--}}
{{--                    <li>--}}
...
{{--                    </li>--}}
{{--                    <li>--}}
{{--                        <a href="{{route('customers.index')}}"><i class="fa fa-table nav_icon"></i>List customers <span class="nav-badge">05</span></a>--}}
{{--                    </li>--}}
{{--                    <li>--}}
    ...
    <div class="sticky-header header-section ">
        <div class="header-left">
            ...
            <div class="logo">
                <a href="index.html">
                    <h1>TAM KÊ</h1>
                    <span>baby chicken</span>
                </a>
            </div>
            <!--//logo-->
            <!--search-box-->
            <div class="search-box">
                <form class="input" method="post" action="{{route('agencys.search')}}">
                    @csrf
                    <div>
...
{{--                            <li> <a href="{{route('show.blog')}}"><i class="fa fa-sign-out"></i> Logout</a> </li>--}}
                        </ul>
                    </li>
                </ul>
            </div>
